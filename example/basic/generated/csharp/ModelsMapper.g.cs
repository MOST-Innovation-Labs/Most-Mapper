...
public class ModelA
{
    ...
    public Dictionary<string, object?> ToJsonMap()
    {
        return new Dictionary<string, object?>
        {
            ...
            ["createdAt"] = CreatedAt == null ? null : CreatedAt.Value.ToString("O"),
        };
    }
    ...
    public static ModelA FromJsonElement(JsonElement json)
    {
        return new ModelA
        {
            ...
            CreatedAt = MostMapperJson.Optional(json, "createdAt") is JsonElement createdAtJson ? DateTime.Parse(createdAtJson.GetString()!) : null,
        };
    }
}
...
public class ModelB
{
    ...
    public static ModelB FromJsonElement(JsonElement json)
    {
        return new ModelB
        {
            ...
            Datetime = DateTime.Parse(json.GetProperty("Datetime").GetString()!),
        };
    }
}
...
public static class MostMapperMappings
{
        ...
        ModelB source)
    {
        ...
        {
            Id = source.Id,
            Datetime = (new DateTimeOffset(source.Datetime).ToString("yyyy-MM-dd'T'HH:mm:sszzz", CultureInfo.InvariantCulture)),
        };
    }
        ...
        ModelA source)
    {
        return new ModelAWire
        {
            ...
            Amount = ((decimal)source.Amount.Value / (decimal)Math.Pow(10, source.Amount.FractionalUnits)),
            ...
            CreatedAt = source.CreatedAt == null ? null : (new DateTimeOffset(source.CreatedAt.Value).ToString("yyyy-MM-dd'T'HH:mm:sszzz", CultureInfo.InvariantCulture)),
            SomeField = null,
        };
    }
